...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Jeevan_bot_movies')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
IMDB_TEMPLATE = environ.get('IMDB_TEMPLATE', f'🎥 <b>‣ ᴛɪᴛʟᴇ</b> : <a href="{url}">{title}</a>  
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "http://jeevanmoviessbot.koyeb.app/")
